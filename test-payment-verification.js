...
const TEST_PAYMENT_CODE = 'ABC123';
async function testPaymentVerification() {
    ...
    try {
        ...
        try {
            const verifyResponse = await axios.post(`${BASE_URL}/api/student/payment/verify-code`, { paymentCode: TEST_PAYMENT_CODE }, {
                headers: {
        ...
        try {
            await axios.post(`${BASE_URL}/api/student/payment/verify-code`, { paymentCode: 'INVALID' }, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
        ...
        try {
            await axios.post(`${BASE_URL}/api/student/payment/verify-code`, {}, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
        ...
        try {
            await axios.post(`${BASE_URL}/api/student/payment/verify-code`, { paymentCode: 'ABC' }, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
